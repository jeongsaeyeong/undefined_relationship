...
const Search = () => {
    ...
    useEffect(() => {
        fetch("https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&key=AIzaSyBz9E2uJGzU730mA40Zm_GcRJ4vvZRykq4")
    ...
    return (
        <section id='searchPage'>
            <div className="search__banner__img"></div>
            <h2>제목</h2>
